...
<body>
    ...
    <div class="all">
        <div class="left">
            <button id="btnStatistics"><a>Statistics</a></button>
            <button id="btnAddProduct"><a>Add Product</a></button>
            <button id="btnDisplayProducts"><a>Display list of available products</a></button>
        </div>
        <div class="right">
